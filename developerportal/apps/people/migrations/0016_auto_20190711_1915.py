...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(name="person", options={}),
        migrations.RenameField(
            model_name="person", old_name="intro", new_name="description"
        ),
        migrations.RenameField(
            model_name="person", old_name="intro_image", new_name="image"
        ),
        migrations.RemoveField(model_name="person", name="first_name"),
        migrations.RemoveField(model_name="person", name="last_name"),
        migrations.RemoveField(model_name="person", name="profile_picture"),
        migrations.AddField(
            model_name="person",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="people_persontag_items",
                        to="taggit.Tag",
                    ),
                ),
            ],
